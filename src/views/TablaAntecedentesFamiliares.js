...
export const TablaAntecedentesFamiliares = () => {
  return (
    <div className='bcg-color d-flex justify-content-center flex-column align-items-center'>
      <h1 className='display-2 text-light'> Antecedentes Familiares </h1>
      <Formik
        initialValues={{
          Diabetes: '',
          Cancer: '',
        ...
        {({ errors, touched }) => (
          ...
          <div role="group" aria-labelledby="my-radio-group">
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="Cancer" id="Cancer" value="Si" />
                Si
            </label>
            <br></br>
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="Cancer" id="Cancer" value="No" />
              No
            </label>
          </div>
            </div>
          ...
          <div role="group" aria-labelledby="my-radio-group">
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="Hipertension" id="Hipertension" value="Si" />
                Si
            </label>
            <br></br>
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="Hipertension" id="Hipertension" value="No" />
              No
            </label>
          </div>
            </div>
          ...
          <div role="group" aria-labelledby="my-radio-group">
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="VIH" id="VIH" value="Si" />
                Si
            </label>
            <br></br>
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="VIH" id="VIH" value="No" />
              No
            </label>
          </div>
            </div>
          ...
          <div role="group" aria-labelledby="my-radio-group">
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="EnfermedadDegenerativa" id="EnfermedadDegenerativa" value="Si" />
                Si
            </label>
            <br></br>
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="EnfermedadDegenerativa" id="EnfermedadDegenerativa" value="No" />
              No
            </label>
          </div>
            </div>
          ...
          <div role="group" aria-labelledby="my-radio-group">
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="EnfermedadMental" id="EnfermedadMental" value="Si" />
                Si
            </label>
            <br></br>
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="EnfermedadMental" id="EnfermedadMental" value="No" />
              No
            </label>
          </div>
            </div>
