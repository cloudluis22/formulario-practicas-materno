      ...
      <Formik
        ...
        {({ errors, touched }) => (
          ...
          <div role="group" aria-labelledby="my-radio-group">
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="RespiradoBucal" id="RespiradoBucal" value="Si" />
                Si
            </label>
            <br></br>
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="RespiradoBucal" id="RespiradoBucal" value="No" />
              No
            </label>
          </div>
            </div>
          ...
          <div role="group" aria-labelledby="my-radio-group">
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="SuccionDigital" id="SuccionDigital" value="Si" />
                Si
            </label>
            <br></br>
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="SuccionDigital" id="SuccionDigital" value="No" />
              No
            </label>
          </div>
            </div>
          ...
          <div role="group" aria-labelledby="my-radio-group">
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="SuccionChupete" id="SuccionChupete" value="Si" />
                Si
            </label>
            <br></br>
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="SuccionChupete" id="SuccionChupete" value="No" />
              No
            </label>
          </div>
            </div>
          ...
          <div role="group" aria-labelledby="my-radio-group">
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="SuccionLabial" id="SuccionLabial" value="Si" />
                Si
            </label>
            <br></br>
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="SuccionLabial" id="SuccionLabial" value="No" />
              No
            </label>
          </div>
            </div>
          ...
          <div role="group" aria-labelledby="my-radio-group">
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="MorderseLabio" id="MorderseLabio" value="Si" />
                Si
            </label>
            <br></br>
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="MorderseLabio" id="MorderseLabio" value="No" />
              No
            </label>
          </div>
            </div>
          ...
          <div role="group" aria-labelledby="my-radio-group">
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="MorderseLasUnas" id="MorderseLasUnas" value="Si" />
                Si
            </label>
            <br></br>
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="MorderseLasUnas" id="MorderseLasUnas" value="No" />
              No
            </label>
          </div>
            </div>
          ...
          <div role="group" aria-labelledby="my-radio-group">
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="DeglucionAtipica" id="DeglucionAtipica" value="Si" />
                Si
            </label>
            <br></br>
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="DeglucionAtipica" id="DeglucionAtipica" value="No" />
              No
            </label>
          </div>
            </div>
          ...
          <div role="group" aria-labelledby="my-radio-group">
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="Otros" id="Otros" value="Si" />
                Si
            </label>
            <br></br>
            <label>
              <Field type="radio" className='form-check-input mx-2'  name="Otros" id="Otros" value="No" />
              No
            </label>
          </div>
            </div>

            {LblOtros && <div className='mb-3'>
