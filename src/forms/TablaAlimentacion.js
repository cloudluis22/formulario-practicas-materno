...
export const TablaAlimentacion = () => {
  return (
    <Formik
      initialValues={{
        ComidasDiarias: '',
      ...
      validate={(values) => {
        ...
        if (!values.Yogurth) {
          errors.Yogurth =
            'Por favor ingresa las veces que consume Yogurth a la semana.';
        }
        ...
        if (!values.Galletas) {
          errors.Galletas = 'Por favor ingrese las veces que consume galletas';
        }
        ...
        if (!values.Mermelada) {
          errors.Mermelada = 'Por favor ingrese las veces que consume pescado.';
        }
        ...
        if (!values.Agua) {
          errors.Agua = 'Por favor ingrese las veces que consume agua al dia.';
        }
        ...
        if (!values.Te) {
          errors.Te = 'Por favor ingrese las veces que consume té a la semana.';
        }
        ...
        <Form
          ...
          <div className='mb-4 mt-2'>
            ...
            <ErrorMessage
              name='ComidasDiarias'
              component={() => (
                <div className='invalid-feedback'>{errors.ComidasDiarias}</div>
              )}
            />
          ...
          <div className='mb-4 mt-2'>
            ...
            <ErrorMessage
              name='Yogurth'
              component={() => (
                <div className='invalid-feedback'>{errors.Yogurth}</div>
              )}
            />
